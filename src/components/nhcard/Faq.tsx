...
export const FAQ_ITEMS = [
  {
    ...
    a: "Да, эту опцию поддерживают большинство карт рейтинга. Зачисление проходит за 1–5 минут, комиссия держится в диапазоне 0–4%. Учтите суточный лимит СБП — 100 000 ₽.",
  },
  {
