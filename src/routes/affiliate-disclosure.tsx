...
export const Route = createFileRoute("/affiliate-disclosure")({
  head: () => ({
    meta: [
      { title: "Раскрытие партнёрских ссылок — Payqo" },
      {
        name: "description",
        content:
          "Часть ссылок на Payqo — партнёрские. Мы можем получать комиссию, но это не влияет ни на цену для пользователя, ни на редакционную оценку.",
      },
      { property: "og:title", content: "Раскрытие партнёрских ссылок — Payqo" },
      {
        property: "og:description",
        content: "Как устроены партнёрские ссылки Payqo и почему они не влияют на рейтинг.",
      },
...
function AffiliateDisclosurePage() {
  return (
    <InfoShell
      ...
      lead="Мы честны с читателем: часть ссылок на Payqo — партнёрские. Ниже — что это значит на практике."
    >
      <H2>Что это значит</H2>
      <P>
        Некоторые кнопки «Оформить» и ссылки в обзорах ведут на сайт эмитента карты через
        партнёрскую ссылку. Если вы оформите карту после перехода, Payqo может получить
      ...
      <H2>Зачем это нам</H2>
      <P>
        Партнёрская модель позволяет Payqo оставаться бесплатным для читателей и не зависеть от
