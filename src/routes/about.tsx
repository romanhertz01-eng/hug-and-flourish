...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "О проекте — Payqo" },
      {
        name: "description",
        content:
          "Payqo — независимый мониторинг зарубежных виртуальных карт для россиян. Как устроена редакция, какие цифры за нами стоят и почему мы не эмитент.",
      },
      { property: "og:title", content: "О проекте — Payqo" },
      {
...
function AboutPage() {
  return (
    <InfoShell
      eyebrow="О проекте"
      title="Payqo — независимый мониторинг зарубежных карт"
    ...
    >
      <H2>Что мы делаем</H2>
      <P>
        Payqo — независимая редакция, которая ведёт мониторинг зарубежных виртуальных карт,
      ...
      <P>
        ...
        предложений. Payqo появился, чтобы отделить работающие продукты от красивых лендингов и
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="rounded-lg border border-border bg-surface p-5">
          ...
          <div className="mt-2 text-sm text-muted-foreground">
            Финтех-аналитик Payqo. Сверяет тарифы, лимиты и условия эмитентов перед публикацией.
          </div>
        </div>
      </div>
