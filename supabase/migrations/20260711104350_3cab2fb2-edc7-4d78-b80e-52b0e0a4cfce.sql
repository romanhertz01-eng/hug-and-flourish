...
('chatgpt','ChatGPT','ai',
 ...
 'Карта для оплаты ChatGPT из РФ 2026 — рейтинг и сравнение | Payqo',
...
('claude','Claude','ai',
 ...
 'Карта для оплаты Claude из РФ 2026 — рейтинг и сравнение | Payqo',
 'Оплата Claude Pro российской картой невозможна. Подобрали зарубежные виртуальные карты, которыми пользователи Payqo успешно оплачивают Anthropic Claude.',
 'карта для оплаты claude', 2),
('netflix','Netflix','streaming',
 'Лучшие карты для оплаты Netflix из России в 2026 году',
 'Карта для оплаты Netflix из РФ 2026 — рейтинг и сравнение | Payqo',
...
('spotify','Spotify','streaming',
 ...
 'Карта для оплаты Spotify из РФ 2026 — рейтинг и сравнение | Payqo',
 'Как оплатить Spotify Premium из России: сравнение виртуальных карт, тарифы, комиссии, скорость выпуска. Проверено редакцией Payqo.',
 'карта для оплаты spotify', 1),
('steam','Steam','games',
 'Лучшие карты для оплаты Steam из России в 2026 году',
 'Карта для оплаты Steam из РФ 2026 — рейтинг и сравнение | Payqo',
...
('playstation','PlayStation','games',
 ...
 'Карта для оплаты PS Store из РФ 2026 — рейтинг и сравнение | Payqo',
...
('amazon','Amazon','shopping',
 ...
 'Карта для оплаты Amazon из РФ 2026 — рейтинг и сравнение | Payqo',
...
('iherb','iHerb','shopping',
 ...
 'Карта для оплаты iHerb из РФ 2026 — рейтинг и сравнение | Payqo',
...
('google-ads','Google Ads','ads',
 ...
 'Карта для Google Ads из РФ 2026 — рейтинг и сравнение | Payqo',
...
('tiktok-ads','TikTok Ads','ads',
 ...
 'Карта для TikTok Ads из РФ 2026 — рейтинг и сравнение | Payqo',
...
('booking','Booking','travel',
 ...
 'Карта для оплаты Booking из РФ 2026 — рейтинг и сравнение | Payqo',
...
('adobe','Adobe','work',
 ...
 'Карта для оплаты Adobe Creative Cloud из РФ 2026 — рейтинг | Payqo',
